...
SELECT r.schemaname, r.relname, pg_size_pretty(pg_relation_size(relid)) AS rel_size, r.seq_scan,
...
select tio.schemaname, tio.relname, tio.heap_blks_read, tio.heap_blks_hit, tio.idx_blks_read, tio.idx_blks_hit,
